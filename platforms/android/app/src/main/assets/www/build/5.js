...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__document__ = __webpack_require__(784);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angular2_signaturepad__ = __webpack_require__(479);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__component_component_module__ = __webpack_require__(771);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_camera_service__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_file_service__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_picture_model__ = __webpack_require__(460);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__camera_camera_component__ = __webpack_require__(770);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_camera__ = __webpack_require__(173);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_angular2_signaturepad_signature_pad__ = __webpack_require__(477);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_document_service__ = __webpack_require__(478);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_app_config__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_toast_service__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_util__ = __webpack_require__(473);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__component_camera_camera_component__ = __webpack_require__(770);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__models_picture_model__ = __webpack_require__(460);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ivt_security__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__terms_of_service_modal_terms_of_service_modal__ = __webpack_require__(466);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DocumentPage = /** @class */ (function () {
    function DocumentPage(domSanitizer, navCtrl, navParams, camera, alertCtrl, translateService, documentService, util, fileService, toastService, securityService, modalCtrl) {
        ...
        this.documentObj = {
            ...
            customerSign: false,
            validateTermOfServiceMessage: null
        };
        this.frontPictures = [];
        this.backPictures = [];
        ...
        this.translateService.get('msg.are_you_sure_you_want_to_save').subscribe(function (value) {
            _this.reservationCompleteString = value;
        });
        this.translateService.get('reservation.validation.term_of_service_message').subscribe(function (value) {
            _this.documentObj.validateTermOfServiceMessage = value;
        });
    ...
    DocumentPage.prototype.save = function () {
        ...
        if (!this.item.isAgreedWithPrivacyPolicy) {
            this.toastService.error(this.documentObj.validateTermOfServiceMessage);
            return;
        }
        var alert = this.alertCtrl.create({
            title: this.confirmString,
            message: this.reservationCompleteString,
            buttons: [
                {
                ...
                },
                {
                    ...
                    handler: function () {
                        if (_this.item.isAgreedWithPrivacyPolicy) {
                            ...
                            _this.toastService.error(_this.documentObj.validateTermOfServiceMessage);
                        }
                    }
                }
            ]
    ...
    DocumentPage.prototype.showTerms = function (showTerms) {
        var profileModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_15__terms_of_service_modal_terms_of_service_modal__["a" /* TermsOfServiceModal */], { showTerms: showTerms });
        profileModal.present();
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.item.customerSignedTime = __WEBPACK_IMPORTED_MODULE_8_moment___default()().format(__WEBPACK_IMPORTED_MODULE_9__app_app_config__["a" /* Config */].date.SeverFormatMoment);
                        _a.label = 3;
                    case 3:
                    ...
                    case 4:
                        ...
                        this.item.consultantSignedTime = __WEBPACK_IMPORTED_MODULE_8_moment___default()().format(__WEBPACK_IMPORTED_MODULE_9__app_app_config__["a" /* Config */].date.SeverFormatMoment);
                        _a.label = 5;
                    case 5:
                        this.saveDocument();
                        return [2 /*return*/];
    ...
    DocumentPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["c" /* DomSanitizer */],
            ...
            __WEBPACK_IMPORTED_MODULE_10__services_toast_service__["a" /* ToastService */], __WEBPACK_IMPORTED_MODULE_14__ivt_security__["d" /* IvtSecurityService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* ModalController */]])
    ], DocumentPage);
    return DocumentPage;
}());
