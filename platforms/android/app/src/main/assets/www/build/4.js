...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vehicle_registration__ = __webpack_require__(805);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__component_component_module__ = __webpack_require__(771);
...
var VehicleRegistrationPageModule = /** @class */ (function () {
    ...
    VehicleRegistrationPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__vehicle_registration__["a" /* VehicleRegistrationPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ngx_translate_core__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_vehicle_service__ = __webpack_require__(461);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_vehicle_type_service__ = __webpack_require__(494);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__component_camera_camera_component__ = __webpack_require__(770);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_bluetooth_service__ = __webpack_require__(465);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__models_device_model__ = __webpack_require__(179);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__services_dialog_service__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_util_service__ = __webpack_require__(60);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VehicleRegistrationPage = /** @class */ (function () {
    function VehicleRegistrationPage(navCtrl, navParams, alertCtrl, toastService, translateService, modalCtrl, viewCtrl, vehicleService, vehicleTypeService, modelYearService, trimService, fileSvc, bluetoothSvc, loadingCtrl, dialogSvc, utils) {
        ...
        this.utils = utils;
        this.message = { noBluetoothDeviceFound: '', scanningBluetoothDevices: '', activateBluetooth: '' };
    ...
    VehicleRegistrationPage.prototype.searchBluetooth = function () {
        ...
        this.dialogSvc.alert(this.message.activateBluetooth).then(function () {
    ...
    VehicleRegistrationPage.prototype.loadTranslation = function () {
        var _this = this;
        this.translateService.get('vehicle_registration.scanning_bluetooth_devices').subscribe(function (value) {
            _this.message.scanningBluetoothDevices = value;
        });
        this.translateService.get('vehicle_registration.no_bluetooth_device_found').subscribe(function (value) {
            _this.message.noBluetoothDeviceFound = value;
        });
        this.translateService.get('vehicle_registration.activate_the_bluetooth_add_on_status_in_the_bluetooth_setting').subscribe(function (value) {
            _this.message.activateBluetooth = value;
        });
                ...
                switch (_b.label) {
                    case 0:
                        loader = this.loadingCtrl.create({
                            content: this.message.scanningBluetoothDevices
                        });
                        loader.present();
                        _a = this;
                    ...
                    case 1:
                        ...
                        if (this.devices.length == 0) {
                            this.dialogSvc.alert(this.message.noBluetoothDeviceFound);
                        }
                        return [2 /*return*/];
                }
            });
