...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__test_drive_result__ = __webpack_require__(801);
...
var TestDriveResultPageModule = /** @class */ (function () {
    ...
    TestDriveResultPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__test_drive_result__["a" /* TestDriveResultPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_test_drive_test_drive__ = __webpack_require__(464);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__models_customer_model__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__services_loading_service__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__app_app_config__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ivt_security__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__services_camera_service__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__services_file_service__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__services_vehicle_odometer_service__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__services_bluetooth_service__ = __webpack_require__(465);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TestDriveResultPage = /** @class */ (function () {
    function TestDriveResultPage(navCtrl, navParams, alertCtrl, testDriveProvider, geolocation, loadingCtrl, util, toastSvr, translate, drivingSvc, loadingSvc, storeage, modalCtrl, camera, fileSvc, vehicleOdometerService, bluetoothSvc) {
        var _this = this;
        ...
        this.displayDateFormat = __WEBPACK_IMPORTED_MODULE_12__app_app_config__["a" /* Config */].date.displayFormatDateSurvey;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.drivingSvc.finishRecord({
                            ...
                            var customer = new __WEBPACK_IMPORTED_MODULE_10__models_customer_model__["a" /* Customer */]();
                            ...
                            _this.navCtrl.setRoot("SurveyDetailPage", { customer: customer }).then(function (_) { return loader.dismiss(); });
    ...
    TestDriveResultPage.prototype.getDrivingRecords = function () {
        ...
        this.drivingRecord.subscribe(function (res) {
            if (res.code === __WEBPACK_IMPORTED_MODULE_4__ivt_http_client__["a" /* APICode */].Success) {
                console.log("getDriving record!: ", res.data);
                for (var _i = 0, _a = res.data; _i < _a.length; _i++) {
                    var item = _a[_i];
                    _this.previousRecordItems.push({
                        drivenStartTime: /* this.util.koreanDateFormat(item.driveStartTime)*/ __WEBPACK_IMPORTED_MODULE_6_moment__(item.driveStartTime).format("LLL"),
                        drivenDurationInSec: __WEBPACK_IMPORTED_MODULE_6_moment__(parseInt(item.drivenDurationInSec) * 1000).utc().format("HH:mm:ss"),
                ...
                _this.displayTotalDrivingTime = __WEBPACK_IMPORTED_MODULE_6_moment__(parseInt(_this.totalDrivingTime) * 1000).utc().format("HH:mm:ss");
    ...
    TestDriveResultPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__providers__["d" /* Util */],
            ...
            __WEBPACK_IMPORTED_MODULE_13__ivt_security__["e" /* IvtStorageService */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_14__services_camera_service__["a" /* CameraService */],
            __WEBPACK_IMPORTED_MODULE_15__services_file_service__["a" /* FileService */],
            __WEBPACK_IMPORTED_MODULE_16__services_vehicle_odometer_service__["a" /* VehicleOdometerService */],
            __WEBPACK_IMPORTED_MODULE_17__services_bluetooth_service__["a" /* BluetoothService */]])
    ], TestDriveResultPage);
