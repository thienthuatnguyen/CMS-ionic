(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('rxjs/operators'), require('class-transformer'), require('rxjs/Observable'), require('rxjs/add/observable/throw'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common/http', 'rxjs/operators', 'class-transformer', 'rxjs/Observable', 'rxjs/add/observable/throw', '@angular/common'], factory) :
	(factory((global.ivtHttpClient = {}),global.ng.core,global.ng.common,global.catchError,global.plainToClass,global.Rx,global.Rx.Observable,global.ng.common));
}(this, (function (exports,core,http,operators,classTransformer,Observable,_throw,common) { 'use strict';
...
var IvtHttpInterceptor = /** @class */ (function () {
    ...
    function (req, next) {
        ...
        return next.handle(req).pipe(operators.map(function (response) {
...
IvtHttpService = /** @class */ (function () {
    ...
    function (res) {
        ...
        if (response.code === APICode.Success) {
            if (response.data instanceof Array) {
                return classTransformer.plainToClass(this.ClazzType, response.data);
            }
            else {
                return classTransformer.plainToClass(this.ClazzType, response.data);
            }
    ...
    function (error) {
        ...
        return Observable.Observable.throw(response);
    };
    /**
     * @param {?=} parentId
     * @return {?}
...
var IvtHttpClientModule = /** @class */ (function () {
    ...
    function () {
        return {
            ...
            providers: [
                IvtHttpClientConfig,
                { provide: http.HTTP_INTERCEPTORS, useClass: IvtHttpInterceptor, multi: true }
            ]
        };
    };
...
exports.IvtHttpInterceptor = IvtHttpInterceptor;
exports.IvtHttpClientConfig = IvtHttpClientConfig;
exports.IvtHttpService = IvtHttpService;
exports.IvtHttpClientModule = IvtHttpClientModule;
