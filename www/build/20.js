...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__reservation__ = __webpack_require__(782);
...
var ReservationPageModule = /** @class */ (function () {
    ...
    ReservationPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__reservation__["a" /* ReservationPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_underscore__ = __webpack_require__(466);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_reservation_service__ = __webpack_require__(470);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__app_app_config__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_vehicle_service__ = __webpack_require__(463);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ivt_security__ = __webpack_require__(37);
...
var ReservationPage = /** @class */ (function () {
    ...
    ReservationPage.prototype.init = function () {
        ...
        if (this.navParam.data.item) {
            ...
            this.reservation.appointmentDate = __WEBPACK_IMPORTED_MODULE_2_moment___default()(this.reservation.appointmentDate).locale(__WEBPACK_IMPORTED_MODULE_8__app_app_config__["a" /* Config */].moment.locale).format(__WEBPACK_IMPORTED_MODULE_8__app_app_config__["a" /* Config */].date.YYYYMMDD);
            ...
            this.reservation.appointmentDate = __WEBPACK_IMPORTED_MODULE_2_moment___default()().locale(__WEBPACK_IMPORTED_MODULE_8__app_app_config__["a" /* Config */].moment.locale).format(__WEBPACK_IMPORTED_MODULE_8__app_app_config__["a" /* Config */].date.YYYYMMDD);
        }
    };
    ...
    ReservationPage.prototype.save = function () {
        var _this = this;
        var title = this.translate.instant('YOUR_RESERVATION_HAS_BEEN_CHANGED_DO_YOU_WANT_TO_SAVE_IT');
            ...
            buttons: [
                {
                    ...
                    handler: function () {
                        ...
                        _this.service.save(_this.reservation).subscribe(function (success) {
                            _this.toastSvc.success(_this.translate.instant('YOUR_RESERVATION_WAS_MADE_OR_WAS_CHANGED_SUCCESSFULLY'));
            ...
            buttons: [
                {
                    ...
                    handler: function () {
                        _this.service.cancel({ id: _this.reservation.id }).subscribe(function (success) {
                            _this.toastSvc.error(_this.translate.instant('YOUR_RESERVATION_WAS_CANCELED_SUCCESSFULLY'));
                            _this.navCtrl.parent.select(2);
                        }, function (fail) {
                            _this.toastSvc.error(fail.message);
                        });
